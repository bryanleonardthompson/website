...
export default defineConfig({
  ...
  integrations: [
    ...
    AstroPWA({
      ...
      includeAssets: ["favicon.ico", "bryan-avatar.jpg"],
      manifest: {
        name: "Bryan Leonard Thompson",
        short_name: "bryanlt",
        description: "Apps, Land Rovers, and photography. Based in Glasgow, Scotland.",
        theme_color: "#006cac",
